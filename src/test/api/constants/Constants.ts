export default class Constants {
  ...
  static readonly SUBTRACT_RESULT_XPATH =
    "//*[local-name()='SubtractResult']/text()";
  static readonly MULTIPLY_RESULT_XPATH =
    "//*[local-name()='MultiplyResult']/text()";
  static readonly DIVIDE_RESULT_XPATH =
    "//*[local-name()='DivideResult']/text()";
