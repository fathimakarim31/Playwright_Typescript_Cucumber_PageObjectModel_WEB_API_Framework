...
export default class RESTRequest {
  ...
  public async createRequestBody(
    ...
    let json = fs.readFileSync(
      CommonConstants.REST_JSON_REQUEST_PATH + jsonFileName,
      "utf-8"
    );
  ...
  private async setRestResponse(
    ...
    const restResponse: RESTResponse = new RESTResponse(
      headers,
      body,
      statusCode,
      description
